...
window.onload = function () {
  ...
  inputLabel.forEach(function (inputText) {
  ...
  */
  ...
  inputTextarea.forEach(function (inputTextarea) {
  ...
  */
  ...
  progressBlock.forEach(function (element) {
  ...
  */
  ...
  Array.from(expandButton).forEach(function (item) {
  ...
  */
  ...
  var currentPlay;
  var videoModalItem;
  playBlock.forEach(function (playBlockItem) {
    ...
    playBlockItem.addEventListener('click', function (e) {
      ...
      if (!closeBlock && !passTestTarget) {
        ...
        setTimeout(function () {
          _this.classList.add('show-video');
