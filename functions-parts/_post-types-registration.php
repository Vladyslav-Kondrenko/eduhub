...
function init_post_types()
{
    register_post_type('events', array(
        ...
        'labels' => array(
            ...
            'singular_name' => 'Події', // название для одной записи этого типа
    ...
    //         'add_new_item' => 'Додавання', // заголовка у вновь создаваемой записи в админ-панели.
    //         'edit_item' => 'Редагувати', // для редактирования типа записи
    //         'new_item' => 'Нова', // текст новой записи
    //         'view_item' => 'Перегляд', // для просмотра записи этого типа.
    //         'search_items' => 'Пошук', // для поиска по этим типам записи
    //         'not_found' => 'Не знайдено', // если в результате поиска ничего не было найдено
    //         'not_found_in_trash' => 'В корзині не знайдено', // если не было найдено в корзине
    ...
    //     'menu_icon' => null,
    //     'hierarchical' => true,
    //     'supports' => array('title', 'author', 'revisions', 'thumbnail'), // 'title','editor','author','thumbnail','excerpt','trackbacks','custom-fields','comments','revisions','page-attributes','post-formats'
    //     'taxonomies' => array(),
    //     'has_archive' => true,
    ...
    register_post_type('requests', array(
        ...
        'labels' => array(
            ...
            'add_new' => 'Додати заявку', // для добавления новой записи
            'add_new_item' => 'Додавання', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item' => 'Редагувати', // для редактирования типа записи
            'new_item' => 'Нова', // текст новой записи
            'view_item' => 'Перегляд', // для просмотра записи этого типа.
        ...
        'taxonomies' => array(),
        'has_archive' => true,
        'rewrite' => array('slug' => 'requests-post'),
        'query_var' => true,
        'menu_icon' => 'dashicons-analytics'
    ));
